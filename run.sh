...
_start() {
    ...
    for i in 1 2 3 4 5; do
        ...
        if curl -s -o /dev/null -w "" "http://localhost:$PORT/" 2>/dev/null; then
            ...
            echo "       $URL"
            echo ""
            echo "  Do NOT use 127.0.0.1 or VS Code Simple Browser — they"
            echo "  hang on remote workspaces. Use the LAN URL above in a"
            echo "  real browser (incognito works best for demos)."
            echo ""
